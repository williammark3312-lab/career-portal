...
export default function JobScreeningPage() {
  ...
  if (!mounted || authLoading) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center bg-transparent text-white relative overflow-hidden font-space">
        <GlassBackground />
  ...
  if (!session || !isRecruiter) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-transparent text-white relative overflow-hidden p-4 font-sans">
        <GlassBackground />
        <motion.div
