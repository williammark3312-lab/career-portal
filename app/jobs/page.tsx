    ...
    <main className="min-h-screen bg-[#F8F9FC] text-zinc-800 relative z-10 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="flex flex-col gap-8">
          ...
          <nav className="flex flex-col gap-1">
            <button
              ...
              className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-xs font-bold text-white bg-zinc-900 border border-zinc-850 cursor-pointer"
            >
      ...
      <div className="flex-1 lg:ml-72 min-h-screen flex flex-col p-4 sm:p-8 lg:p-10 relative z-10 pt-20 lg:pt-10 overflow-y-auto">
        <div className="max-w-5xl w-full mx-auto flex flex-col gap-6 flex-grow pb-16">
          ...
          {/* Job Openings Table (Admin Mirror) */}
          {loading ? (
                ...
                {submitted ? (
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <div 
                        className="prose prose-zinc text-zinc-650 font-medium text-sm leading-relaxed"
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                              <div className="flex flex-col gap-1.5">
                                ...
                                <div className="flex">
                                  <span className="inline-flex items-center px-3.5 rounded-l-xl border border-r-0 border-zinc-200 bg-zinc-50 text-[11px] font-bold text-zinc-400 select-none">
                                    +91
                                  </span>
                                  <input
                                    value={phone}
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <div className="relative rounded-xl border border-dashed border-zinc-300 bg-white hover:bg-zinc-50/50 hover:border-zinc-400 p-6 text-center cursor-pointer transition-colors">
                                <input
                                  type="file"
                                  accept=".pdf,.doc,.docx"
